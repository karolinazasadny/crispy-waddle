...
tolerance = float(raw_input ("Podaj tolerancję upraszczania budynków [stopnie]: "))*m.pi/180
k = int(raw_input ("Podaj liczbę wierzchołków odcinanych przez sieczną (>2): "))

if k<3: k = int(raw_input ("Podaj liczbę wierzchołków odcinanych przez sieczną (>2): "))
